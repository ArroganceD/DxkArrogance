...
public class ShiroConfig {
	...
	public ShiroFilterFactoryBean getShiroFilterFactoryBean(DefaultSecurityManager securityManager, Realm realm) {
		...
		filterChainDefinitionMap.put("/admin/commercial/index", "perms[system:user:index]");
		filterChainDefinitionMap.put("/admin/commercial/add", "perms[system:user:add]");
		filterChainDefinitionMap.put("/admin/commercial/edit*", "perms[system:user:edit]");
		filterChainDefinitionMap.put("/admin/commercial/deleteBatch", "perms[system:user:deleteBatch]");
